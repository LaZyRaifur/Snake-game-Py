...
# the width and height can be put as user's choce
...
# the score will be returned to zero and a high score will be retained untill the window is not closed
    ...
    for segment in segments:
        if segment.distance(head) < 20:
            ...
            pen.write("Score : {} High Score: {}".
                      format(score,high_score),align="center",font=("candara",24,"bold") )
    time.sleep(delay)
wn.mainloop()
